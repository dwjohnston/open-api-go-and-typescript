...
//go:generate swagger generate server --target ../../backend --name SwaggerPetstore --spec ../../spec/petstore-separate/spec/swagger.json --principal interface{}
...
func configureAPI(api *operations.SwaggerPetstoreAPI) http.Handler {
	...
	if api.AddPetHandler == nil {
		api.AddPetHandler = operations.AddPetHandlerFunc(func(params operations.AddPetParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.AddPetHandler has not yet been implemented")
		})
	}
	...
	if api.FindPetsHandler == nil {
		api.FindPetsHandler = operations.FindPetsHandlerFunc(func(params operations.FindPetsParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.FindPetsHandler has not yet been implemented")
		})
	}
